!function (t, e) {
  ...
  return function (t) {
      ...
      a(r, "$vantLang", "zh-CN"), a(r, "$vantMessages", {
          "zh-CN": {
              ...
              vanContactCard: {addText: "娣诲姞鑱旂郴浜�"},
              vanContactList: {addText: "鏂板缓鑱旂郴浜�"},
              vanPagination: {prev: "涓婁竴椤�", next: "涓嬩竴椤�"},
              vanPullRefresh: {pulling: "涓嬫媺鍗冲彲鍒锋柊...", loosing: "閲婃斁鍗冲彲鍒锋柊..."},
              vanSubmitBar: {label: "鍚堣锛�"},
              vanCoupon: {
                  valid: "鏈夋晥鏈�", unlimited: "鏃犱娇鐢ㄩ棬妲�", discount: function (t) {
                      return t + "鎶�"
              ...
              vanCouponCell: {
                  title: "浼樻儬鍒�", tips: "浣跨敤浼樻儬", count: function (t) {
                      return t + "寮犲彲鐢�"
                  }
              },
              vanCouponList: {
              ...
              vanAddressEditDetail: {label: "璇︾粏鍦板潃", placeholder: "琛楅亾闂ㄧ墝銆佹ゼ灞傛埧闂村彿绛変俊鎭�"},
              vanAddressList: {add: "鏂板鍦板潃"}
          }
      });
      e.a = {
          messages: function () {
   ...
   */
      ...
      function yi(t, e, i, n) {
          ...
          return t(re, o()([{
              ...
              scopedSlots: {
                  default: function () {
                      var i = e.data,
                          n = [t("div", {class: bi("name")}, [i.name + "锛�" + i.tel]), t("div", {class: bi("address")}, [i.address])];
      ...
      Ei.props = {
          ...
          currency: {type: String, default: "楼"}
      };
      ...
      function yn(t, e, i, n) {
          ...
          }, h(n)]), ["add" === s ? e.addText || bn("addText") : [t("div", [bn("name") + "锛�" + e.name]), t("div", [bn("tel") + "锛�" + e.tel])]])
      }
                  ...
                  scopedSlots: {
                      default: function () {
                          return t(mi, {
                              ...
                              on: {click: s}
                          }, [t("div", {class: Bn("name")}, [e.name + "锛�" + e.tel])])
                      }, "right-icon": function () {
                          return t(vt, {
      ...
      var Xn = Hn({
          props: {coupon: Object, chosen: Boolean, disabled: Boolean, currency: {type: String, default: "楼"}},
          computed: {
              validPeriod: function () {
                  var t = this.coupon, e = t.startAt, i = t.endAt;
                  return qn("valid") + "锛�" + Yn(e) + " - " + Yn(i)
              }, faceAmount: function () {
                  var t, e = this.coupon;
          ...
          props: {
              ...
              if (!this.isSkuEmpty) {
                  var i = this.sku, n = this.goods, s = this.price, o = this.originPrice, r = this.skuEventBus,
                      ...
                      }, [f("sku-header-price") || e("div", {class: "van-sku__goods-price"}, [e("span", {class: "van-sku__price-symbol"}, ["锟�"]), e("span", {class: "van-sku__price-num"}, [s]), this.priceTag && e("span", {class: "van-sku__price-tag"}, [this.priceTag])]), f("sku-header-origin-price") || o && e(Da, [Dl("originPrice"), " 锟�", o]), !this.hideStock && e(Da, [e("span", {class: "van-sku__stock"}, [this.stockText]), !c && this.quotaText && e("span", {class: "van-sku__quota"}, ["(", this.quotaText, ")"])]), this.hasSku && !this.hideSelectedText && e(Da, [this.selectedText]), f("sku-header-extra")]),
      ...
      Qo.a.add({
          "zh-CN": {
              ...
              vanSkuActions: {buy: "绔嬪嵆璐拱", addCart: "鍔犲叆璐墿杞�"},
              vanSkuImgUploader: {
                  oversize: function (t) {
                      return "鏈€澶у彲涓婁紶鍥剧墖涓�" + t + "MB锛岃灏濊瘯鍘嬬缉鍥剧墖灏哄"
                  }, fail: "涓婁紶澶辫触<br />閲嶆柊涓婁紶"
              },
              vanSkuStepper: {num: "璐拱鏁伴噺"},
              vanSkuMessages: {
                  fill: "璇峰～鍐�",
                  upload: "璇蜂笂浼�",
                  imageLabel: "浠呴檺涓€寮�",
                  invalid: {tel: "璇峰～鍐欐纭殑鏁板瓧鏍煎紡鐣欒█", mobile: "鎵嬫満鍙烽暱搴︿负6-20浣嶆暟瀛�", email: "璇峰～鍐欐纭殑閭", id_no: "璇峰～鍐欐纭殑韬唤璇佸彿鐮�"},
                  placeholder: {
                      id_no: "杈撳叆韬唤璇佸彿鐮�",
                      text: "杈撳叆鏂囨湰",
                      tel: "杈撳叆鏁板瓧",
